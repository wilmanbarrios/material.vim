...
" Vim Editor
call s:SetHighlight('ColorColumn', '', s:selection, '')
...
call s:SetHighlight('MatchParen', s:yellow, s:selection, 'bold')
...
" Treesitter
call s:SetHighlight('TSNone', '', '', '')
call s:SetHighlight("TSStrong", '', '', 'bold')
call s:SetHighlight("TSUnderline", '', '', 'undercurl')
call s:SetHighlight("TSEmphasis", '', '', 'italic')
...
call s:SetHighlight("TSConstant", s:yellow, '', '')
call s:SetHighlight("TSConstBuiltin", s:orange, '', '')
call s:SetHighlight("TSConstMacro", s:yellow, '', '')
call s:SetHighlight("TSString", s:green, '', '')
call s:SetHighlight("TSNumber", s:orange, '', '')
...
call s:SetHighlight("TSConditional", s:purple, '', '')
